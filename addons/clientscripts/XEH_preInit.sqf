...
["ZSN_Jukebox",				"CHECKBOX",	["Jukebox","Dynamic ambient Music"],																		"ZluskeN Client Settings",True,							nil,{params ["_value"]; ZSN_Jukebox = _value; if (ZSN_Jukebox) then {["initialize"] call BIS_fnc_jukebox} else {["terminate"] call BIS_fnc_jukebox}}] call CBA_fnc_addSetting;
