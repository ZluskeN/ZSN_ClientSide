...
["ZSN_replaceWeapons",		"EDITBOX",	["Weapons to replace","Replace all weapons found in this list with respective ones from the list below"],	"ZluskeN Gunplay Settings",'["hgun_P07_blk_F","hgun_P07_khk_F","hgun_P07_F","arifle_MXC_Black_F","arifle_MX_Black_F","arifle_MXM_Black_F","arifle_MXC_F","arifle_MX_F","arifle_MXM_F","arifle_MX_SW_Black_F","arifle_MX_SW_F","arifle_MX_GL_Black_F","arifle_MX_GL_F","arifle_Mk20_F","arifle_Mk20C_F","arifle_Mk20_GL_F","srifle_DMR_03_F","LMG_03_F"]',nil,{params ["_value"]; if (typeName _value == "STRING") then {ZSN_replaceweapons = call compile _value} else {ZSN_replaceweapons = _value}},false] call CBA_fnc_addSetting;
["ZSN_replaceWeaponsWith",	"EDITBOX",	["Weapons to replace with","weapons in above list will be replaced with respective ones in this list"],		"ZluskeN Gunplay Settings",'["CUP_hgun_M17_Black","CUP_hgun_M17_Coyote","CUP_hgun_M17_Green","KAR_XM7_BLK","KAR_XM7_BLK","KAR_XM7_BLK_G","KAR_XM7","KAR_XM7","KAR_XM7_G","KAR_XM250_BLK","KAR_XM250","glaunch_GLX_lxWS","glaunch_GLX_tan_lxWS","CUP_arifle_Mk16_STD_woodland","CUP_arifle_Mk16_CQC_woodland","CUP_arifle_Mk16_CQC_EGLM_woodland","CUP_arifle_Mk20_woodland","CUP_lmg_m249_SQuantoon"]',nil,{params ["_value"]; if (typeName _value == "STRING") then {ZSN_replaceweaponsWith = call compile _value} else {ZSN_replaceweaponsWith = _value}},false] call CBA_fnc_addSetting;
